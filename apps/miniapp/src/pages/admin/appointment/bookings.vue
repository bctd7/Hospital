...
<template>
  <view class="page">
    <view class="summary">
      <view class="summary__info"><text class="summary__title">{{ departmentLabel }}</text><text class="summary__minor">{{ isCompletedView ? '查询本科室诊后检查记录' : '按房间处理今日检查队列' }}</text></view>
