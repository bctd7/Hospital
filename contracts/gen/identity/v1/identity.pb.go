...
const file_identity_v1_identity_proto_rawDesc = "" +
	"\n" +
	"\x1aidentity/v1/identity.proto\x12\x14hospital.identity.v1\"P\n" +
	...
	"\t_nicknameB\x0f\n" +
	"\r_masked_phoneB\x15\n" +
	"\x13_staff_display_name\"\xcb\x01\n" +
	"\tTokenPair\x12!\n" +
	...
	"\foperation_id\x18\x03 \x01(\tR\voperationId\x12\x1d\n" +
	"\n" +
	"request_id\x18\x04 \x01(\tR\trequestId2\xa5\x16\n" +
...
var file_identity_v1_identity_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_identity_v1_identity_proto_goTypes = []any{
	...
	(*GetAccountDisplayProfileRequest)(nil),     // 7: hospital.identity.v1.GetAccountDisplayProfileRequest
	(*UpdateAccountDisplayProfileRequest)(nil),  // 8: hospital.identity.v1.UpdateAccountDisplayProfileRequest
	(*AccountDisplayProfile)(nil),               // 9: hospital.identity.v1.AccountDisplayProfile
	(*TokenPair)(nil),                           // 10: hospital.identity.v1.TokenPair
	(*HospitalSummary)(nil),                     // 11: hospital.identity.v1.HospitalSummary
	(*CampusSummary)(nil),                       // 12: hospital.identity.v1.CampusSummary
	(*DepartmentSummary)(nil),                   // 13: hospital.identity.v1.DepartmentSummary
	(*AdminOrganizationUnit)(nil),               // 14: hospital.identity.v1.AdminOrganizationUnit
	(*GetOrganizationContextRequest)(nil),       // 15: hospital.identity.v1.GetOrganizationContextRequest
	(*OrganizationContext)(nil),                 // 16: hospital.identity.v1.OrganizationContext
	(*ListDepartmentsRequest)(nil),              // 17: hospital.identity.v1.ListDepartmentsRequest
	(*ListDepartmentsResponse)(nil),             // 18: hospital.identity.v1.ListDepartmentsResponse
	(*DoctorSummary)(nil),                       // 19: hospital.identity.v1.DoctorSummary
	(*ListDoctorsByDepartmentRequest)(nil),      // 20: hospital.identity.v1.ListDoctorsByDepartmentRequest
	(*ListDoctorsByDepartmentResponse)(nil),     // 21: hospital.identity.v1.ListDoctorsByDepartmentResponse
	(*ListOrganizationUnitsRequest)(nil),        // 22: hospital.identity.v1.ListOrganizationUnitsRequest
	(*ListOrganizationUnitsResponse)(nil),       // 23: hospital.identity.v1.ListOrganizationUnitsResponse
	(*GetOrganizationUnitRequest)(nil),          // 24: hospital.identity.v1.GetOrganizationUnitRequest
	(*CreateOrganizationUnitRequest)(nil),       // 25: hospital.identity.v1.CreateOrganizationUnitRequest
	(*UpdateOrganizationUnitRequest)(nil),       // 26: hospital.identity.v1.UpdateOrganizationUnitRequest
	(*ChangeOrganizationUnitStatusRequest)(nil), // 27: hospital.identity.v1.ChangeOrganizationUnitStatusRequest
	(*AdminAccountSummary)(nil),                 // 28: hospital.identity.v1.AdminAccountSummary
	(*AdminAccountDetail)(nil),                  // 29: hospital.identity.v1.AdminAccountDetail
	(*ListAdminAccountsRequest)(nil),            // 30: hospital.identity.v1.ListAdminAccountsRequest
	(*ListAdminAccountsResponse)(nil),           // 31: hospital.identity.v1.ListAdminAccountsResponse
	(*GetAdminAccountRequest)(nil),              // 32: hospital.identity.v1.GetAdminAccountRequest
	(*SearchAdminAccountByPhoneRequest)(nil),    // 33: hospital.identity.v1.SearchAdminAccountByPhoneRequest
	(*SearchAdminAccountByPhoneResponse)(nil),   // 34: hospital.identity.v1.SearchAdminAccountByPhoneResponse
	(*PromoteDoctorRequest)(nil),                // 35: hospital.identity.v1.PromoteDoctorRequest
	(*UpdateDoctorRequest)(nil),                 // 36: hospital.identity.v1.UpdateDoctorRequest
	(*ChangeDoctorDepartmentRequest)(nil),       // 37: hospital.identity.v1.ChangeDoctorDepartmentRequest
	(*AccountMutationRequest)(nil),              // 38: hospital.identity.v1.AccountMutationRequest
}
var file_identity_v1_identity_proto_depIdxs = []int32{
	11, // 0: hospital.identity.v1.OrganizationContext.hospital:type_name -> hospital.identity.v1.HospitalSummary
	12, // 1: hospital.identity.v1.OrganizationContext.campuses:type_name -> hospital.identity.v1.CampusSummary
	13, // 2: hospital.identity.v1.ListDepartmentsResponse.items:type_name -> hospital.identity.v1.DepartmentSummary
	19, // 3: hospital.identity.v1.ListDoctorsByDepartmentResponse.items:type_name -> hospital.identity.v1.DoctorSummary
	14, // 4: hospital.identity.v1.ListOrganizationUnitsResponse.items:type_name -> hospital.identity.v1.AdminOrganizationUnit
	28, // 5: hospital.identity.v1.AdminAccountDetail.summary:type_name -> hospital.identity.v1.AdminAccountSummary
	28, // 6: hospital.identity.v1.ListAdminAccountsResponse.items:type_name -> hospital.identity.v1.AdminAccountSummary
	28, // 7: hospital.identity.v1.SearchAdminAccountByPhoneResponse.identity:type_name -> hospital.identity.v1.AdminAccountSummary
	3,  // 8: hospital.identity.v1.SearchAdminAccountByPhoneResponse.phone:type_name -> hospital.identity.v1.PhoneBinding
	...
	4,  // 11: hospital.identity.v1.IdentityService.RefreshAccessToken:input_type -> hospital.identity.v1.RefreshAccessTokenRequest
	5,  // 12: hospital.identity.v1.IdentityService.RevokeRefreshToken:input_type -> hospital.identity.v1.RevokeRefreshTokenRequest
	7,  // 13: hospital.identity.v1.IdentityService.GetAccountDisplayProfile:input_type -> hospital.identity.v1.GetAccountDisplayProfileRequest
	8,  // 14: hospital.identity.v1.IdentityService.UpdateAccountDisplayProfile:input_type -> hospital.identity.v1.UpdateAccountDisplayProfileRequest
	15, // 15: hospital.identity.v1.IdentityService.GetOrganizationContext:input_type -> hospital.identity.v1.GetOrganizationContextRequest
	17, // 16: hospital.identity.v1.IdentityService.ListDepartments:input_type -> hospital.identity.v1.ListDepartmentsRequest
	20, // 17: hospital.identity.v1.IdentityService.ListDoctorsByDepartment:input_type -> hospital.identity.v1.ListDoctorsByDepartmentRequest
	22, // 18: hospital.identity.v1.IdentityService.ListOrganizationUnits:input_type -> hospital.identity.v1.ListOrganizationUnitsRequest
	24, // 19: hospital.identity.v1.IdentityService.GetOrganizationUnit:input_type -> hospital.identity.v1.GetOrganizationUnitRequest
	25, // 20: hospital.identity.v1.IdentityService.CreateOrganizationUnit:input_type -> hospital.identity.v1.CreateOrganizationUnitRequest
	26, // 21: hospital.identity.v1.IdentityService.UpdateOrganizationUnit:input_type -> hospital.identity.v1.UpdateOrganizationUnitRequest
	27, // 22: hospital.identity.v1.IdentityService.DisableOrganizationUnit:input_type -> hospital.identity.v1.ChangeOrganizationUnitStatusRequest
	27, // 23: hospital.identity.v1.IdentityService.EnableOrganizationUnit:input_type -> hospital.identity.v1.ChangeOrganizationUnitStatusRequest
	30, // 24: hospital.identity.v1.IdentityService.ListAdminAccounts:input_type -> hospital.identity.v1.ListAdminAccountsRequest
	32, // 25: hospital.identity.v1.IdentityService.GetAdminAccount:input_type -> hospital.identity.v1.GetAdminAccountRequest
	33, // 26: hospital.identity.v1.IdentityService.SearchAdminAccountByPhone:input_type -> hospital.identity.v1.SearchAdminAccountByPhoneRequest
	35, // 27: hospital.identity.v1.IdentityService.PromoteDoctor:input_type -> hospital.identity.v1.PromoteDoctorRequest
	36, // 28: hospital.identity.v1.IdentityService.UpdateDoctor:input_type -> hospital.identity.v1.UpdateDoctorRequest
	37, // 29: hospital.identity.v1.IdentityService.ChangeDoctorDepartment:input_type -> hospital.identity.v1.ChangeDoctorDepartmentRequest
	38, // 30: hospital.identity.v1.IdentityService.RevokeDoctor:input_type -> hospital.identity.v1.AccountMutationRequest
	38, // 31: hospital.identity.v1.IdentityService.DisableAccount:input_type -> hospital.identity.v1.AccountMutationRequest
	38, // 32: hospital.identity.v1.IdentityService.EnableAccount:input_type -> hospital.identity.v1.AccountMutationRequest
	1,  // 33: hospital.identity.v1.IdentityService.SendPhoneLoginCode:output_type -> hospital.identity.v1.SendPhoneLoginCodeResponse
	10, // 34: hospital.identity.v1.IdentityService.PhoneLogin:output_type -> hospital.identity.v1.TokenPair
	10, // 35: hospital.identity.v1.IdentityService.RefreshAccessToken:output_type -> hospital.identity.v1.TokenPair
	6,  // 36: hospital.identity.v1.IdentityService.RevokeRefreshToken:output_type -> hospital.identity.v1.RevokeRefreshTokenResponse
	9,  // 37: hospital.identity.v1.IdentityService.GetAccountDisplayProfile:output_type -> hospital.identity.v1.AccountDisplayProfile
	9,  // 38: hospital.identity.v1.IdentityService.UpdateAccountDisplayProfile:output_type -> hospital.identity.v1.AccountDisplayProfile
	16, // 39: hospital.identity.v1.IdentityService.GetOrganizationContext:output_type -> hospital.identity.v1.OrganizationContext
	18, // 40: hospital.identity.v1.IdentityService.ListDepartments:output_type -> hospital.identity.v1.ListDepartmentsResponse
	21, // 41: hospital.identity.v1.IdentityService.ListDoctorsByDepartment:output_type -> hospital.identity.v1.ListDoctorsByDepartmentResponse
	23, // 42: hospital.identity.v1.IdentityService.ListOrganizationUnits:output_type -> hospital.identity.v1.ListOrganizationUnitsResponse
	14, // 43: hospital.identity.v1.IdentityService.GetOrganizationUnit:output_type -> hospital.identity.v1.AdminOrganizationUnit
	14, // 44: hospital.identity.v1.IdentityService.CreateOrganizationUnit:output_type -> hospital.identity.v1.AdminOrganizationUnit
	14, // 45: hospital.identity.v1.IdentityService.UpdateOrganizationUnit:output_type -> hospital.identity.v1.AdminOrganizationUnit
	14, // 46: hospital.identity.v1.IdentityService.DisableOrganizationUnit:output_type -> hospital.identity.v1.AdminOrganizationUnit
	14, // 47: hospital.identity.v1.IdentityService.EnableOrganizationUnit:output_type -> hospital.identity.v1.AdminOrganizationUnit
	31, // 48: hospital.identity.v1.IdentityService.ListAdminAccounts:output_type -> hospital.identity.v1.ListAdminAccountsResponse
	29, // 49: hospital.identity.v1.IdentityService.GetAdminAccount:output_type -> hospital.identity.v1.AdminAccountDetail
	34, // 50: hospital.identity.v1.IdentityService.SearchAdminAccountByPhone:output_type -> hospital.identity.v1.SearchAdminAccountByPhoneResponse
	29, // 51: hospital.identity.v1.IdentityService.PromoteDoctor:output_type -> hospital.identity.v1.AdminAccountDetail
	29, // 52: hospital.identity.v1.IdentityService.UpdateDoctor:output_type -> hospital.identity.v1.AdminAccountDetail
	29, // 53: hospital.identity.v1.IdentityService.ChangeDoctorDepartment:output_type -> hospital.identity.v1.AdminAccountDetail
	29, // 54: hospital.identity.v1.IdentityService.RevokeDoctor:output_type -> hospital.identity.v1.AdminAccountDetail
	29, // 55: hospital.identity.v1.IdentityService.DisableAccount:output_type -> hospital.identity.v1.AdminAccountDetail
	29, // 56: hospital.identity.v1.IdentityService.EnableAccount:output_type -> hospital.identity.v1.AdminAccountDetail
...
func file_identity_v1_identity_proto_init() {
	...
	file_identity_v1_identity_proto_msgTypes[19].OneofWrappers = []any{}
	...
	file_identity_v1_identity_proto_msgTypes[29].OneofWrappers = []any{}
	file_identity_v1_identity_proto_msgTypes[35].OneofWrappers = []any{}
