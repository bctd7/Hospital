...
1. `02-business-boundary.md`：业务范围、角色和核心流程。
2. `03-service-boundary.md`：微服务边界与服务依赖。
3. `04-data-design.md`：数据库选型、数据归属和迁移规范。
4. `05-api-contract.md`：小程序 API、错误码和鉴权约定。
5. `06-infrastructure.md`：Redis、Kafka、etcd 和 Docker Compose。
6. `07-observability-and-security.md`：指标、链路、安全与隐私。
7. `08-implementation-roadmap.md`：迭代顺序和验收标准。
