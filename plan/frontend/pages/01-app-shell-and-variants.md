...
- 首页“诊前服务”的卡片位置和整体结构不随身份变化：患者端继续显示“我的预约”并进入本人预约记录；
  科室医生在同一位置显示“科室预约”，使用会话中的 `department_id` 进入所属科室预约列表，不允许在
  前端替换为其他科室。超级管理员没有固定所属科室时，先进入检查资源管理页选择科室，再查看预约；
...
- 医生和超级管理员可进入同一工作人员框架；
- 工作人员仍可使用患者端本人功能；
- 患者端“我的预约”入口、文案和跳转不受工作人员端入口调整影响；
- 科室医生从工作人员首页进入预约列表时，只查询会话所属科室；
