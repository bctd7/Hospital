...
func booking(value *appointmentv1.Booking) *types.BookingResponse {
	return &types.BookingResponse{
		...
		ExaminationEndedAt:       value.ExaminationEndedAt, ExaminationEndedBy: value.ExaminationEndedBy,
		ExaminationEndedByDisplayName: value.ExaminationEndedByDisplayName,
		QueueNumber:                   value.QueueNumber, CurrentCalledQueueNumber: value.CurrentCalledQueueNumber,
		PeopleAhead: value.PeopleAhead, CheckedInAt: value.CheckedInAt, CalledAt: value.CalledAt,
		CallDeadline: value.CallDeadline, CallAttempts: value.CallAttempts,
