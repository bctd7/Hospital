...
func (l *CheckInBookingLogic) CheckInBooking(req *types.CheckInBookingAPIRequest) (resp *types.BookingResponse, err error) {
	...
	value, err := l.svcCtx.Appointment.CheckInBooking(rpcCtx, &appointmentv1.CheckInBookingRequest{
		BookingId: req.BookingID, ExpectedVersion: req.ExpectedVersion, OperationId: req.OperationID, RequestId: requestID,
	})
	if err != nil {
		return nil, err
	}
