...
- `manager/patient/`：患者独有的预约生命周期，包括查询预约选项、创建预约、查询本人预约和取消本人预约。
- `manager/staff/`：管理员和授权科室工作人员独有的管理及现场操作。根层只保留项目、房间、房间—项目关系和预约四个业务方向；房间开放时间归房间，项目预约时间归项目。
