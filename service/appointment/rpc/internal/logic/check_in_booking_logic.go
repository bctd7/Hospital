...
import (
	...
	"hospital/service/appointment/rpc/internal/manager/patient"
...
func NewCheckInBookingLogic(ctx context.Context, svcCtx *svc.ServiceContext) *CheckInBookingLogic {
	return &CheckInBookingLogic{ctx: ctx, svcCtx: svcCtx, Logger: logx.WithContext(ctx)}
}
...
func (l *CheckInBookingLogic) CheckInBooking(in *appointmentv1.CheckInBookingRequest) (*appointmentv1.Booking, error) {
	...
	value, err := l.svcCtx.PatientManager.CheckIn(l.ctx, principal, patient.CheckInCommand{
		BookingID: in.GetBookingId(), ExpectedVersion: in.GetExpectedVersion(), OperationID: in.GetOperationId(), RequestID: in.GetRequestId(),
	})
	if err != nil {
