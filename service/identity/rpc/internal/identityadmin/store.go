...
type Store interface {
	...
	WithinIdentityAdminTransaction(ctx context.Context, fn func(TxStore) error) error
}

type TxStore interface {
	FindIdentityAdminOperation(ctx context.Context, operationID string) (Operation, bool, error)
	GetIdentityAdminAccountForUpdate(ctx context.Context, accountID string) (Account, error)
	...
	RecordIdentityAdminChange(ctx context.Context, change Change) error
}
